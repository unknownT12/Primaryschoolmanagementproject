...
<html>
<head>
    <title>Dashboard | Primary School Admin</title>
    ...
    <main class="yt-main">
        ...
        <div class="yt-stat-grid">
            <div class="yt-stat">
                ...
                <small class="text-muted">Total registered learners</small>
            </div>
            <div class="yt-stat">
            ...
            <div class="yt-stat">
                ...
                <small class="text-muted">Learning groups</small>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-6">
                <div class="yt-card yt-card--list">
                    <div class="yt-card__header">
                        <span class="yt-card__title">Quick actions</span>
                    </div>
                    <div class="list-group list-group-flush">
                        <a href="${pageContext.request.contextPath}/students?action=new" class="list-group-item">Register new student</a>
                        <a href="${pageContext.request.contextPath}/teachers?action=new" class="list-group-item">Add teacher</a>
                        <a href="${pageContext.request.contextPath}/subjects" class="list-group-item">Manage subjects</a>
                        <a href="${pageContext.request.contextPath}/grades" class="list-group-item">Capture grades</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-7">
                <div class="yt-card">
                    <div class="yt-card__header">
                        ...
                        <a href="${pageContext.request.contextPath}/students" class="text-muted small text-decoration-none">View all</a>
                    </div>
                        ...
                        <table class="yt-table">
                            ...
                            <c:forEach var="student" items="${recentStudents}">
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">${student.status}</span></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
