...
<div class="yt-shell">
    ...
    <main class="yt-main">
        ...
        <div class="yt-card">
            <div class="yt-card__header">
                <span class="yt-card__title">Students enrolled in this subject</span>
                <span class="text-muted small">${not empty students ? students.size() : 0} student(s)</span>
            </div>
            <c:choose>
                <c:when test="${empty students}">
                    <p class="yt-empty-state">No students are currently enrolled in this subject.</p>
                </c:when>
                <c:otherwise>
                    <div class="table-responsive">
                        <table class="yt-table">
                            ...
                            <c:forEach var="student" items="${students}">
                                <tr>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/studentDetails?id=${student.studentId}" 
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${student.averageGrade != null}">
                                                <span class="fw-semibold">
                                                    <fmt:formatNumber value="${student.averageGrade}" maxFractionDigits="1"/>%
                                                </span>
                                            </c:when>
                                            <c:otherwise>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/studentDetails?id=${student.studentId}" 
                                           class="yt-button" style="padding: 0.4rem 1rem; font-size: 0.8rem; display: inline-block;">
                                            View Profile
                                        </a>
                                    </td>
                                </tr>
